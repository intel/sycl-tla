...
def main():
    ...
    parser.add_argument("--layout", default="rcr", help="Layout tag to assign to generated shapes.")
    args = parser.parse_args()

    output_dir = profiler.ensure_dir(Path(args.output_dir).resolve())
    shapes_doc, reference_doc = profiler.build_ali_gemm_docs(args.xlsx, layout=args.layout)
