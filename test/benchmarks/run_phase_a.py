...
def main():
    ...
    parser = argparse.ArgumentParser(description="Run Phase A capability probing for the Intel GEMM profiler.")
    ...
    parser.add_argument("--probe-mode", choices=["auto", "static", "run"], default="run")
