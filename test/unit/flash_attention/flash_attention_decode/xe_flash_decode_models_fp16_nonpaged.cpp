...
TEST(XE_Flash_Attention_Decode_FP16, fp16_h96_kv512_causal_varlen_whisper) {
...
TEST(XE_Flash_Attention_Decode_FP16, fp16_h96_kv512_causal_varlen_llama8b) {
  using Shape_h = test::flash_attention::Shape_h96<512, 8>;
  using Kernel = test::flash_attention::XE_Flash_Attention_Decode<half_t, float, float,
                  typename Shape_h::ShapeQK, typename Shape_h::ShapePV,
                  typename Shape_h::ShapeOutput, typename Shape_h::SubgroupLayout,
...
TEST(XE_Flash_Attention_Decode_FP16, fp16_h96_kv512_causal_varlen_llama405b) {
  using Shape_h = test::flash_attention::Shape_h96<512, 8>;
  using Kernel = test::flash_attention::XE_Flash_Attention_Decode<half_t, float, float,
                  typename Shape_h::ShapeQK, typename Shape_h::ShapePV,
                  typename Shape_h::ShapeOutput, typename Shape_h::SubgroupLayout,
...
TEST(XE_Flash_Attention_Decode_FP16, fp16_h96_kv512_causal_varlen_qwen25) {
  using Shape_h = test::flash_attention::Shape_h96<512, 8>;
  using Kernel = test::flash_attention::XE_Flash_Attention_Decode<half_t, float, float,
                  typename Shape_h::ShapeQK, typename Shape_h::ShapePV,
                  typename Shape_h::ShapeOutput, typename Shape_h::SubgroupLayout,
...
TEST(XE_Flash_Attention_Decode_FP16, fp16_h96_kv512_causal_varlen_deepseek) {
  using Shape_h = test::flash_attention::Shape_h96<512, 8>;
  using Kernel = test::flash_attention::XE_Flash_Attention_Decode<half_t, float, float,
                  typename Shape_h::ShapeQK, typename Shape_h::ShapePV,
                  typename Shape_h::ShapeOutput, typename Shape_h::SubgroupLayout,
...
// h128 × KV512 × Causal × VarLen × [model]
TEST(XE_Flash_Attention_Decode_FP16, fp16_h128_kv512_causal_varlen_whisper) {
...
TEST(XE_Flash_Attention_Decode_FP16, fp16_h128_kv512_causal_varlen_llama8b) {
  using Shape_h = test::flash_attention::Shape_h128<512, 8>;
  using Kernel = test::flash_attention::XE_Flash_Attention_Decode<half_t, float, float,
                  typename Shape_h::ShapeQK, typename Shape_h::ShapePV,
                  typename Shape_h::ShapeOutput, typename Shape_h::SubgroupLayout,
...
TEST(XE_Flash_Attention_Decode_FP16, fp16_h128_kv512_causal_varlen_llama405b) {
  using Shape_h = test::flash_attention::Shape_h128<512, 8>;
  using Kernel = test::flash_attention::XE_Flash_Attention_Decode<half_t, float, float,
                  typename Shape_h::ShapeQK, typename Shape_h::ShapePV,
                  typename Shape_h::ShapeOutput, typename Shape_h::SubgroupLayout,
...
TEST(XE_Flash_Attention_Decode_FP16, fp16_h128_kv512_causal_varlen_qwen25) {
  using Shape_h = test::flash_attention::Shape_h128<512, 8>;
  using Kernel = test::flash_attention::XE_Flash_Attention_Decode<half_t, float, float,
                  typename Shape_h::ShapeQK, typename Shape_h::ShapePV,
                  typename Shape_h::ShapeOutput, typename Shape_h::SubgroupLayout,
...
TEST(XE_Flash_Attention_Decode_FP16, fp16_h128_kv512_causal_varlen_deepseek) {
  using Shape_h = test::flash_attention::Shape_h128<512, 8>;
  using Kernel = test::flash_attention::XE_Flash_Attention_Decode<half_t, float, float,
                  typename Shape_h::ShapeQK, typename Shape_h::ShapePV,
                  typename Shape_h::ShapeOutput, typename Shape_h::SubgroupLayout,
...
// h192 × KV512 × Causal × VarLen × [model]
TEST(XE_Flash_Attention_Decode_FP16, fp16_h192_kv512_causal_varlen_whisper) {
...
TEST(XE_Flash_Attention_Decode_FP16, fp16_h192_kv512_causal_varlen_llama8b) {
  using Shape_h = test::flash_attention::Shape_h192<512, 8>;
  using Kernel = test::flash_attention::XE_Flash_Attention_Decode<half_t, float, float,
                  typename Shape_h::ShapeQK, typename Shape_h::ShapePV,
                  typename Shape_h::ShapeOutput, typename Shape_h::SubgroupLayout,
...
TEST(XE_Flash_Attention_Decode_FP16, fp16_h192_kv512_causal_varlen_llama405b) {
  using Shape_h = test::flash_attention::Shape_h192<512, 8>;
  using Kernel = test::flash_attention::XE_Flash_Attention_Decode<half_t, float, float,
                  typename Shape_h::ShapeQK, typename Shape_h::ShapePV,
                  typename Shape_h::ShapeOutput, typename Shape_h::SubgroupLayout,
...
TEST(XE_Flash_Attention_Decode_FP16, fp16_h192_kv512_causal_varlen_qwen25) {
  using Shape_h = test::flash_attention::Shape_h192<512, 8>;
  using Kernel = test::flash_attention::XE_Flash_Attention_Decode<half_t, float, float,
                  typename Shape_h::ShapeQK, typename Shape_h::ShapePV,
                  typename Shape_h::ShapeOutput, typename Shape_h::SubgroupLayout,
...
TEST(XE_Flash_Attention_Decode_FP16, fp16_h192_kv512_causal_varlen_deepseek) {
  using Shape_h = test::flash_attention::Shape_h192<512, 8>;
  using Kernel = test::flash_attention::XE_Flash_Attention_Decode<half_t, float, float,
                  typename Shape_h::ShapeQK, typename Shape_h::ShapePV,
                  typename Shape_h::ShapeOutput, typename Shape_h::SubgroupLayout,
