...
void prefetch_a_rowmajor_d16_m8v2_k16v2_sg16(
        global ushort *A, int rowStart, int colStart, int stride) {
...
void prefetch_b_rowmajor_d16_k16_n16v2_sg16(
        global ushort *B, int rowStart, int colStart, int stride) {
#if defined(PREFETCH_DEFAULT)
    uint offset = colStart + (rowStart + get_sub_group_local_id()) * stride;
...
void prefetch_b_vnni_d16_k16v2_n16_sg16(
        global ushort *B, int rowStart, int colStart, int stride) {
#if defined(PREFETCH_DEFAULT)
...
SYCL_DEVICE_BUILTIN(void __builtin_IB_subgroup_block_read_prefetch_u16_m8k16v1(
        ...
        int pitch_minus_one, coord_t coord, enum LSC_LDCC cache_control));
...
void intel_subgroup_block_prefetch_u16_m8k16(const __global void *base_address,
        int width, int height, int pitch, coord_t coord) {
#if defined(PREFETCH_DEFAULT)
    __builtin_IB_subgroup_block_read_prefetch_u16_m8k16v1(as_long(base_address),
            width - 1, height - 1, pitch - 1, coord, BLOCK_PREFETCH_CACHE_TYPE);
#endif // defined(PREFETCH_DEFAULT)
}
void intel_subgroup_block_prefetch_u16_m8k16v2(__global void *base_address,
        int width, int height, int pitch, coord_t coord) {
#if defined(PREFETCH_DEFAULT)
    __builtin_IB_subgroup_block_read_prefetch_u16_m8k16v2(as_long(base_address),
            width - 1, height - 1, pitch - 1, coord, BLOCK_PREFETCH_CACHE_TYPE);
#endif // defined(PREFETCH_DEFAULT)
}
...
void intel_subgroup_block_prefetch_u32_m8k16(const __global void *base_address,
        int width, int height, int pitch, coord_t coord) {
#if defined(PREFETCH_DEFAULT)
    __builtin_IB_subgroup_block_read_prefetch_u32_m8k16v1(as_long(base_address),
            width - 1, height - 1, pitch - 1, coord, BLOCK_PREFETCH_CACHE_TYPE);
#endif // defined(PREFETCH_DEFAULT)
}
