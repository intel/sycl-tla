; ------------------------------------------------
; OCL_asm23954d4a795eca46_simd32_entry_0006.visa.ll
...
; BB0 :
  ...
  %11 = ptrtoint i32 addrspace(1)* %0 to i64		; visa id: 6
  %12 = shl nuw nsw i64 %10, 2		; visa id: 6
  %13 = add i64 %12, %11		; visa id: 7
  %14 = inttoptr i64 %13 to i32 addrspace(1)*		; visa id: 8
  store i32 %1, i32 addrspace(1)* %14, align 4		; visa id: 8
