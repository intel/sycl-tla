//.kernel _ZTSN4sycl3_V16detail18RoundedRangeKernelINS0_4itemILi1ELb1EEELi1EZNS0_7handler4fillIhEEvPvRKT_mEUlNS0_2idILi1EEEE_EE
//.platform XE2
//.thread_config numGRF=256, numAcc=8, numSWSB=32
//.options_string "-emitCrossThreadOffR0Reloc -perfmodel -hashmovs 596987210 2036255302 -hashmovs1 0 7 "
//.full_options "-emitLocation -wideMulMadOpsEn -enableCoalesceScalarMoves -supportLSCImmScale 0 -samplerHeaderWA -enablePreemptionR0Only -hasRNEandDenorm -noStitchExternFunc -useInlineData -emitCrossThreadOffR0Reloc -abortonspill -TotalGRFNum 256 -abortOnSpill 4 -enableBCR -enableBundleCR 3 -perfmodel -freqBasedSpillCost 8 -freqBasedSpillCostFunc 1 -boundsChecking -presched-ctrl 6 -presched-rp 100 -nodpsendreorder -SBIDDepLoc -PVCSendWARWA -output -binary -dumpcommonisa -dumpcombinedcisa -dumpvisa -printHexFloatInAsm -noverifyCISA -enableHalfLSC -partialInt64 -activeThreadsOnlyBarrier -hashmovs 596987210 2036255302 -hashmovs1 0 7 "
//.instCount 70
...
//.declare V0046 (56)  rf=r size=1 type=b align=2 words (r5.8)
...
//.declare V0053 (63)  rf=r size=1 type=b align=2 words (r5.36)
//.declare V0055 (65)  rf=r size=8 type=d align=2 words (r3.0)
//.declare V0056 (66)  rf=r size=8 type=d alias=V0044+0 align=4 words (r4.6)
//.declare V0060 (70)  rf=r size=12 type=ud alias=V0038+0 align=2 words (r4.3)
//.declare V0061 (71)  rf=r size=32 type=ud alias=V0035+0 align=16 words (r2.0)
//.declare V0062 (72)  rf=r size=4 type=d align=32 words (r7.0)
//.declare V0066 (76)  rf=r size=8 type=q align=32 words (r8.0)
//.declare V0067 (77)  rf=r size=8 type=d alias=V0066+0 align=4 words (r8.0)
//.declare V0069 (79)  rf=r size=64 type=uw alias=V0039+0 align=32 words (r1.0)
//.declare V0072 (82)  rf=r size=12 type=ud alias=V0036+0 align=2 words (r4.0)
//.declare V0076 (86)  rf=r size=128 type=d align=32 words (r9.0)
//.declare V0077 (87)  rf=r size=128 type=d align=32 words (r11.0)
//.declare P01 (88)  rf=f32  size=4 type=uw align=2 words (f1.0)
//.declare V0078 (89)  rf=r size=128 type=ud alias=V0076+0 align=32 words (r9.0)
//.declare V0079 (90)  rf=r size=8 type=ud alias=V0055+0 align=2 words (r3.0)
//.declare P02 (91)  rf=f32  size=4 type=uw align=2 words (f0.0)
//.declare P03 (92)  rf=f32  size=4 type=uw align=2 words (f1.0)
//.declare V0080 (93)  rf=r size=128 type=ud alias=V0077+0 align=32 words (r11.0)
//.declare V0081 (94)  rf=r size=8 type=q align=4 words (r3.1)
//.declare V0082 (95)  rf=r size=12 type=ud alias=V0037+0 align=2 words (r6.0)
//.declare V0085 (98)  rf=r size=256 type=uq align=32 words (r13.0)
//.declare V0086 (99)  rf=r size=1 type=ub alias=V0046+0 align=2 words (r5.8)
...
//.declare  (127)  rf=r size=128 type=q align=32 words (r35.0)
//.declare  (128)  rf=r size=128 type=q align=32 words (r37.0)
//.declare  (131)  rf=r size=128 type=d align=32 words (r39.0)
//.declare  (132)  rf=r size=128 type=d align=32 words (r41.0)
//.declare  (133)  rf=r size=128 type=d alias=+0 align=32 words (r31.0)
//.declare  (134)  rf=r size=128 type=d alias=+0 align=32 words (r33.0)
//.declare  (135)  rf=r size=128 type=d alias=+0 align=32 words (r35.0)
//.declare  (136)  rf=r size=128 type=d alias=+0 align=32 words (r37.0)
...
//.declare  (144)  rf=r size=32 type=ud align=2 words (r6.0)
...
_0_009:
        add (16|M0)              r35.0<1>:q    r31.0<1;1,0>:q    r3.1<0;1,0>:q    {Compacted,I@1}    //  ALU pipe: int; $35
        add (16|M16)             r37.0<1>:q    r33.0<1;1,0>:q    r3.1<0;1,0>:q    {Compacted}        //  ALU pipe: int; $35
        sync.nop                             null                             {Compacted,$4.src}     // $31
        add (16|M0)              r13.0<1>:q    r31.0<1;1,0>:q    r5.0<0;1,0>:q    {Compacted,$2.dst} //  ALU pipe: int; $31
        mov (16|M0)              r19.0<1>:d    r35.0<2;1,0>:d                   {Compacted,I@3}      //  ALU pipe: int; $36
        mov (16|M16)             r20.0<1>:d    r37.0<2;1,0>:d                   {Compacted,I@3}      //  ALU pipe: int; $37
        mov (16|M0)              r21.0<1>:d    r35.1<2;1,0>:d                   {Compacted}          //  ALU pipe: int; $38
        mov (16|M16)             r22.0<1>:d    r37.1<2;1,0>:d                   {Compacted}          //  ALU pipe: int; $39
        cmp (32|M0)   (lt)f0.0   null<1>:ud    r19.0<1;1,0>:ud   r3.0<0;1,0>:ud   {I@3}              //  ALU pipe: int; $40 R{} IR{}{O:1,O:1,},  R{r3,} IR{} {BC=1}
        add (16|M16)             r15.0<1>:q    r33.0<1;1,0>:q    r5.0<0;1,0>:q    {Compacted}        //  ALU pipe: int; $31
        mov (32|M0)              r17.0<1>:ud   r5.8<0;1,0>:ub                                        //  ALU pipe: int; $33
(f0.0)  cmp (32|M0)   (eq)f0.0   null<1>:d     r21.0<1;1,0>:d    r3.1<0;1,0>:d    {I@4}              //  ALU pipe: int; $41
        store.ugm.d8u32.a64 (32|M0)  [r13:4]    r17:2              {I@2,$4} // ex_desc:0x0; desc:0x8000984 // $34
(~f0.0) cmp (32|M0)   (lt)f0.0   null<1>:ud    r21.0<1;1,0>:ud   r3.1<0;1,0>:ud                      //  ALU pipe: int; $43
(~f0.0) goto (32|M0)                         _0_007            _0_007                                //  ALU pipe: int; $45
// B005: [inDivergent],  Preds:{B004},  Succs:{B004}
_0_010:
(f0.0)  sel (32|M0)              r39.0<1>:d    r19.0<1;1,0>:d    r9.0<1;1,0>:d                       //  ALU pipe: int; $47
(f0.0)  sel (32|M0)              r41.0<1>:d    r21.0<1;1,0>:d    r11.0<1;1,0>:d                      //  ALU pipe: int; $48
        mov (16|M0)              r31.0<2>:d    r39.0<1;1,0>:d                   {I@2}                //  ALU pipe: int; $51
        mov (16|M16)             r33.0<2>:d    r40.0<1;1,0>:d                                        //  ALU pipe: int; $52
        mov (16|M0)              r31.1<2>:d    r41.0<1;1,0>:d                   {I@3}                //  ALU pipe: int; $53
        mov (16|M16)             r33.1<2>:d    r42.0<1;1,0>:d                                        //  ALU pipe: int; $54
(W)     jmpi                                 _0_009                                                  // $55
// B006: Preds:{B004, B002},  Succs:{}
_0_007:
        join (32|M0)                         L864                                                    // 
L864:
        sync.nop                             null                             {Compacted,$3.src}     // $57
(W)     mov (16|M0)              r255.0<1>:f   r2.0<1;1,0>:f                    {Compacted,$2.src}   //  ALU pipe: float; $57
(W)     send.gtwy (1|M0)         null     r255  null:0  0x0            0x02000010           {EOT,F@1,$5} // wr:1+0, rd:0; end of thread // $57
L896:
