//.kernel _ZTSZN4sycl3_V17handler4fillIjEEvPvRKT_mEUlNS0_2idILi1EEEE_
//.platform XE2
//.thread_config numGRF=256, numAcc=8, numSWSB=32
//.options_string "-emitCrossThreadOffR0Reloc -perfmodel -hashmovs 596987210 2036255302 -hashmovs1 0 6 "
//.full_options "-emitLocation -wideMulMadOpsEn -enableCoalesceScalarMoves -supportLSCImmScale 0 -samplerHeaderWA -enablePreemptionR0Only -hasRNEandDenorm -noStitchExternFunc -useInlineData -emitCrossThreadOffR0Reloc -abortonspill -TotalGRFNum 256 -abortOnSpill 4 -enableBCR -forceBCR -enableBundleCR 3 -perfmodel -freqBasedSpillCost 8 -freqBasedSpillCostFunc 1 -boundsChecking -presched-ctrl 6 -presched-rp 100 -nodpsendreorder -SBIDDepLoc -PVCSendWARWA -output -binary -dumpcommonisa -dumpcombinedcisa -dumpvisa -printHexFloatInAsm -noverifyCISA -enableHalfLSC -partialInt64 -activeThreadsOnlyBarrier -hashmovs 596987210 2036255302 -hashmovs1 0 6 "
//.instCount 35
...
//.declare V0035 (45)  rf=r size=4 type=d align=2 words (r5.0)
...
//.declare V0057 (67)  rf=r size=128 type=d align=32 words (r12.0)
...
//.declare  (73)  rf=r size=128 type=q align=32 words (r19.0)
//.declare  (74)  rf=r size=128 type=q align=32 words (r21.0)
//.declare r0 (75)  rf=r size=64 type=ud align=32 words (r0.0)
//.declare rtmp (76)  rf=r size=64 type=ud align=32 words (r255.0)
//.declare inlineRegFromTDL (77)  rf=r size=32 type=ud align=2 words (r1.0)
//.declare inlineRegExpectedLocation (78)  rf=r size=32 type=ud align=2 words (r4.0)
//.declare  (79)  rf=r size=128 type=ud align=32 words (r1.0)
//.declare  (80)  rf=r size=64 type=ud align=32 words (r3.0)
//.declare  (81)  rf=r size=32 type=ud align=2 words (r5.0)
...
(W)     mul (1|M0)               acc0.0<1>:d   r4.3<0;1,0>:d     r2.2<0;1,0>:uw   {A@1}              //  ALU pipe: int; $2
        mov (32|M0)              r12.0<1>:f    r5.0<0;1,0>:f                    {Compacted,$2.dst}   //  ALU pipe: float; $8
...
(W)     mov (16|M0)              r255.0<1>:f   r2.0<1;1,0>:f                    {Compacted}          //  ALU pipe: float; $10
        ...
        shl (16|M0)              r19.0<1>:q    r14.0<2;1,0>:ud   2:w               {I@2}             //  ALU pipe: int; $6
        shl (16|M16)             r21.0<1>:q    r16.0<2;1,0>:ud   2:w               {I@2}             //  ALU pipe: int; $6
        ...
        store.ugm.d32.a64 (32|M0)  [r8:4]       r12:2              {A@1,$3} // ex_desc:0x0; desc:0x8000584 // $9
